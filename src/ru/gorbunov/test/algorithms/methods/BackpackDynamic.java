...
/**
 * Первая строка входа содержит целые числа 1≤W≤104 и 1≤n≤300 — вместимость рюкзака и число золотых слитков. Следующая
 * строка содержит n целых чисел 0≤w_1,…,w_n≤10^5, задающих веса слитков.
